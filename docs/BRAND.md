...
## The metaphor (the whole docs voice)
...
| Crawlers / scrapers | the riffraff — never getting past the rope |
...
Plainspoken, a little theatrical. The README tells the story straight: frontier crawlers sweep public tunnels for IP — here's the rope.
